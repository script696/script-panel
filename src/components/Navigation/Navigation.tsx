...
import { Avatar, Box, Drawer, Grid, List, ListItemAvatar, ListItemButton, ListItemText } from "@mui/material";
...
const Navigation = () => {
	const { isMobileMenuOpen, colorMode } = useAppSelector((state) => state.UiReducer);
