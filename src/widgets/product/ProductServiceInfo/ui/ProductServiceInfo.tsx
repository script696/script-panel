	...
	return (
		<>
			...
			<ModalPopup
				...
				height="auto"
			>
				<TextFieldsModalContent onCancelForm={onCloseServiceInfoModal} formId="ProductServiceInfoForm">
					<ProductServiceInfoForm product={product} onSubmit={handleSubmitAddressInfoForm} />
